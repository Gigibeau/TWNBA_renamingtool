        ...
        for key, value in names.items():
            if key == parts[underscore_count + 1]:
                ...
                if parts[-2] == "3D":
                    ...
                    new_name = new_name_builder + key + '_' + value + '_3D' + "." + parts[-1]
                ...
                # Renaming the 2D files
                    ...
                    new_name = new_name_builder + key + '_' + value + '_2D' + "." + parts[-1]
                    print("Replacing " + file + "'s name with " + new_name)
                    os.rename(file, new_name)
                    ...
                    try:
                        ...
                        new_name = new_name_builder + key + '_' + value + "." + parts[-1]
                        print("Replacing " + file + "'s name with " + new_name)
                        os.rename(file, new_name)
        ...
        for old_name in csv_data['LEXT name']:
            ...
            for key, value in names.items():
                ...
                if key == parts[underscore_count + 2]:
                    ...
                    new_name = new_name_builder + key + '_' + value
